    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-custom">
      <div class="container">
        <div class="navbar-header page-scroll">
          <a class="navbar-brand" style="margin-top: 10pt;">Login Admin Inventory</a>
        </div>
      </div>
    </nav>
...
<li>
<a href="https://www.facebook.com/AqmalAjiFadillah123/" target="_blank"><i class="fa fa-facebook fa-fw fa-2x"></i></a>
</li>
<li>
<a href="https://github.com/aqmalaji" target="_blank"><i class="fa fa-github fa-fw fa-2x"></i></a>
</li>
<li>
<a href="https://www.linkedin.com/in/aqmal-aji-8b7406181/" target="_blank"><i class="fa fa-linkedin fa-fw fa-2x"></i></a>
</li>
</ul>
<hr class="medium">
<p class="text-muted" style="font-size: 16px;">Copyright &copy;<script>document.write(new Date().getFullYear());</script> Aqmal Aji Fadillah All rights reserved</p>
</div>
</section>
</footer>
